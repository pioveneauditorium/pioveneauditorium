...
function showEvent(eventDate) {
  ...
  if (event) {
    ...
    eventBox.innerHTML = 'Non ci sono eventi questo giorno. Seleziona un giorno colorato per scoprire gli eventi in programma. I giorni in GIALLO corrispondono a proiezioni al CINEMA. I giorni in VIOLA corrispondono a spettacoli al TEATRO. I giorni in ARANCIONE corrispondono a eventi MUSICALI. Grazie e buona navigazione!';
  }
