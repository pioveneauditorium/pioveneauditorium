document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch('https://docs.google.com/spreadsheets/d/e/2PACX-1vTsHetVu62LIgBfbWqJ9AX5vRjWJBiN01Wspsj51i8nr9z5pWKqVb2jG3Zy_aAwJKjN0OiYxZ4mx9-1/pub?output=csv')
      ...
      .then(data => {
        ...
        rows.forEach(row => {
          ...
          // Descrizione troncata con "Scopri di più" inline
          ...
          // Aggiunge click event al testo "Scopri di più"
  ...
  function openEventModal(eventData) {
    ...
    // Rimuovo overflow hidden sul body per permettere scroll interno
    // document.body.style.overflow = 'hidden'; <-- rimosso
  }

  function closeEventModal() {
    modal.classList.remove('active');
    // document.body.style.overflow = ''; <-- rimosso
  }
